...
""")
    ...
    print('-'*50)
    printc(f"Base url is {inspected_webpage.base_url}")
    printc(f"Redirected url is {inspected_webpage.redirected_url}")
    printc(f"Origin url is {inspected_webpage.origin_url}")
    printc(f"Headers are {inspected_webpage.headers}")
